...
plt.xlabel('λ')
plt.ylabel('Tr[P]')
plt.plot(lamudas, Ps_avg, label='不完全时钟同步模型')
plt.scatter([lamudas] * loops_mc, Ps_mc, color='red', marker='.', alpha=0.9, label='蒙特卡洛随机实验')
plt.plot(lamudas, Ps_cmp, label='完全时钟同步模型')
